...
| 8  | **Различия в прибыли по поставщикам**  <br> H₀: Средняя прибыль от продаж разных поставщиков одинакова. <br> H₁: Средняя прибыль различается в зависимости от поставщика. | H₀ отвергнута     | hypothesis_08.ipynb  |
...
Результаты Kruskal–Wallis:  
- H-статистика = 1297.2354. Значение очень большое, различия между группами (поставщиками) выражены сильно.  
- p-value = 1.38e-263. Это крайне малое значение (практически 0), поэтому мы уверенно отвергаем нулевую гипотезу.  
Средняя прибыль значимо различается между поставщиками.  

Результаты Eta-squared (или ε²):  
 - η² = 0.0610. Это означает, что примерно 6.1% вариации в прибыли объясняется фактором "поставщик". 
