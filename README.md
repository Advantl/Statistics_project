...
|----|----------------------------------------------------------------------------------------------------------------------------------|-------------------|----------------------|
| 1  | **Форма оплаты и средний чек**  <br> H₀: Средний чек не зависит от формы оплаты (наличные / безналичные). <br> H₁: Средний чек различается в зависимости от формы оплаты. | H₀ отвергнута     | hypothesis_01.ipynb  |
| 2  | **День недели и продажи**  <br> H₀: Средний объём продаж одинаковый в разные дни недели. <br> H₁: Есть статистически значимые различия в продажах между днями. | H₀ не отвергнута  | hypothesis_02.ipynb  |
