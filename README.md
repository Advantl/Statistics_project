...
*План рабоботы: Проверка параметрических гипотез для двух выборок. Проверка гипотезы о равенстве долей.Либо использовать Доверительный интервал для разности двух долей* <br>
