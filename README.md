...
| **Cramér’s V**                        | Категориальные данные (χ²-тест)    | 0.05–0.10        | 0.15–0.30           | ≥ 0.35 (зависит от размера таблицы) | Cohen, 1988 (адаптировано по числу df) |
...
- Реализовано: Cliff’s Delta, Cohen’s d, Eta-squared / Epsilon-squared, Cramér’s V, Rank-biserial — комплексная интерпретация статистических различий и дополнение традиционного анализа на основе p-значений.
