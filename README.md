...
В случае наличия данных о локации аптек — проверить, различается ли структура прибыльности в зависимости от региона, формата (город/пригород), уровня покупательской активности и локальных предпочтений.   
...
Провести повторную кластеризацию с учётом дополнительных признаков (например, средний чек, доля возвратов, частота поставок), что позволит выделить более устойчивые профили поставщиков.  
